...
use crate::{
    Result,
    wallet::rebased::{AccountAddress, Identifier},
};

use super::language_storage_min::{StructTag, TypeTag};
use super::runtime_value_min::{self as R};
// use crate::{
//     //     VARIANT_COUNT_MAX,
...
impl MoveValue {
    ...
    /// `BoundedVisitor`.
    pub fn simple_deserialize(blob: &[u8], ty: &MoveTypeLayout) -> Result<Self> {
