...
impl CompiledModule {
    ...
    pub fn find_function_def_by_name(
        ...
        self.function_defs().iter().enumerate().find_map(|(idx, def)| {
    ...
    pub fn find_struct_def_by_name(&self, name: &str) -> Option<(StructDefinitionIndex, &StructDefinition)> {
        self.struct_defs()
            .iter()
            .enumerate()
            .find(|(_idx, def)| {
    ...
    pub fn find_enum_def_by_name(&self, name: &str) -> Option<(EnumDefinitionIndex, &EnumDefinition)> {
        self.enum_defs()
            .iter()
            .enumerate()
            .find(|(_idx, def)| {
