...
```Rust
pub extern "C" fn __swift_bridge__CawaenaSdk_get_user_state(callback_wrapper: *mut std::ffi::c_void, callback: extern "C" fn(*mut std::ffi::c_void, ResultUserStateAndString), this: *mut super::CawaenaSdk)
```
