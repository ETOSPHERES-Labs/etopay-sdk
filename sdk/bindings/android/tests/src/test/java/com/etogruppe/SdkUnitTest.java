...
import com.etogruppe.model.CaseDetailsResponse;
import com.etogruppe.model.CaseIdResponse;
import com.etogruppe.model.NewViviswapUser;
import com.etogruppe.model.TransactionStatusResponse;
import com.etogruppe.model.TxDetailsResponse;
import com.etogruppe.model.ViviswapKycStatus;
import com.etogruppe.model.ViviswapPartiallyKycDetails;

@OrderWith(Alphanumeric.class)
public class SdkUnitTest {
    private static CryptpaySdk sdk;
    ...
    public void AshouldCreateNewUser() throws Exception {
        String body = """
                   {"networks":[{"id":"67a1f08edf55756bae21e7eb","name":"IOTA","currency":"IOTA","block_explorer_url":"https://explorer.shimmer.network/testnet/","enabled":true,"network_identifier":"iota_mainnet","network_type":{"Stardust":{"node_url":"https://api.testnet.iotaledger.net"}}},{"id":"67a2080ddf55756bae21e7f5","name":"Eth Sepolia","currency":"ETH","block_explorer_url":"https://sepolia.explorer.mode.network","enabled":true,"network_identifier":"ethereum_mainnet","network_type":{"Evm":{"node_url":"https://sepolia.mode.network","chain_id":31337}}}]}
                """;
