...
code-coverage:
	cargo llvm-cov nextest --release --locked --all-features --lib --workspace --html --exclude etopay-sdk-jni --exclude etopay-sdk-swift --exclude etopay-sdk-wasm --ignore-filename-regex "sdk/bindings/|api_types/|.*/error\.rs" --no-fail-fast
