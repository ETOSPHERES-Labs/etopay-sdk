...
code-coverage:
	cargo llvm-cov nextest --release --locked --all-features --lib --workspace --html --exclude etopay-sdk-jni --exclude cawaena-sdk-swift --exclude cawaena-sdk-wasm --ignore-filename-regex "sdk/bindings/|api_types/|.*/error\.rs" --no-fail-fast
